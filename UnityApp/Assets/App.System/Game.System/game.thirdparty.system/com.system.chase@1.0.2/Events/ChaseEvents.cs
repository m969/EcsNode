...
namespace ECSGame.ChaseModule
{
    ...
    /// <summary>区域越界事件派发接口。</summary>
    public interface IOnChaseAreaViolated : IDispatch
    {
        /// <summary>当追踪实体违反区域限制时触发。</summary>
        /// <param name="entity">追踪实体。</param>
        /// <param name="strategy">越界处理策略。</param>
        void OnChaseAreaViolated(EcsEntity entity, OutOfAreaStrategy strategy);
    }
}
