...
namespace ECSGame
{
    ...
    public class AIComponent : EcsComponent
    {
        ...
        public Dictionary<int, float> Int2FloatValues { get; set; } = new();
        public Dictionary<int, long> Int2LongValues { get; set; } = new();
        public Dictionary<int, bool> Int2BoolValues { get; set; } = new();
