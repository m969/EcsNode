...
namespace ECSGame.AchieveModule
{
        ...
        IDestroy<AchieveCondition>
    {
        ...
        void IAfterInit<AchieveCondition>.AfterInit(AchieveCondition entity) { }
        void IEnable<AchieveCondition>.Enable(AchieveCondition entity) { }
        void IDisable<AchieveCondition>.Disable(AchieveCondition entity) { }
        ...
        void IDestroy<AchieveCondition>.Destroy(AchieveCondition entity) { }
